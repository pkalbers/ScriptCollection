...
print("MarkerID Fk SampleID0 Chr0 SampleID1 Chr1 Shared LHS RHS TrueLHS TrueRHS MRCA TMRCA")
...
for line in list:
	...
	if count == 10:
		...
		for run in runs:
			print("%d %d %d %s %d %s %d %d %d %d %d %d %.6f" % (run['mid'], run['mfk'], run['SampleID0'], run['Chr0'], run['SampleID1'], run['Chr1'], run['shr'], run['infL'], run['infR'], run['xlhs'], run['xrhs'], run['last'], run['time']))
